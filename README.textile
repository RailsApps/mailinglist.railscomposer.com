...
The application connects via MailChimp's API using the "Gibbon":https://github.com/amro/gibbon gem.
...
Rails Composer connects to the mailinglist.railscomposer.com application via the API. Email addresses are added to the mailing list and are not used for anything else.
